...
const { dashboardData, createExpenditure, updateExpenditureById, deleteExpenditureById, getExpenditureById, getDateWisePaymentsStatements, checkPassward, changePassword,getMonthWiseExpenditure  } = require('../Controller/dashboard');
...
router.post("/expenditure/month-wise", getMonthWiseExpenditure);
